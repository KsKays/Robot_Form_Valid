...
*** Variables ***
${BROWSER}                  Chrome
${INPUT_FIRSTNAMEENG}       จัดเบส
${INPUT_IDCARD}             9999999999
${INPUT_PASSWORD}           999999
${INPUT_PHONENUM}           999999999
${INPUT_EMAIL}              best@gmail.com
...
Open Google ReactForm
    Open Browser    https://react-form-valid-three.vercel.app/    ${BROWSER}
